...
export function createExampleDatabase(): DbcDatabase {
  const db: DbcDatabase = {
    name: "j1939_eec_example.dbc",
    version: "1.0",
    nodes: ["ENGINE", "DIAGNOSTIC_TOOL"],
    messages: [
      {
        uid: uid("msg"),
        id: 0x0cf00400,
        ...
        transmitter: "ENGINE",
        cycleTime: 100,
        comment: "Standard J1939 EEC1 example, PGN 61444 (0xF004), source address 0x00.",
        signals: [
          {
            ...createSignal(0),
          ...
          {
            ...createSignal(4),
            name: "SourceAddressOfControllingDevice",
            startBit: 40,
            length: 8,
            factor: 1,
            max: 255,
      ...
      },
      {
        ...
        transmitter: "ENGINE",
        cycleTime: 50,
        comment: "Standard J1939 EEC2 example, PGN 61443 (0xF003), source address 0x00.",
        signals: [
          {
            ...createSignal(0),
            name: "AcceleratorPedal1LowIdleSwitch",
            startBit: 0,
            length: 2,
            factor: 1,
            max: 3,
          ...
          {
            ...createSignal(1),
            name: "AcceleratorPedal1Position",
            startBit: 8,
            length: 8,
            factor: 0.4,
            max: 100,
          ...
          {
            ...createSignal(2),
            name: "EnginePercentLoadAtCurrentSpeed",
            startBit: 16,
            length: 8,
            factor: 1,
            max: 250,
          ...
          {
            ...createSignal(3),
            name: "RemoteAcceleratorPedalPosition",
            startBit: 24,
            length: 8,
            factor: 0.4,
            max: 100,
