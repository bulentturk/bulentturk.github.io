...
const content = {
  tr: {
    ...
    featured: [
      ...
      { code: "PGN / 05", title: "J1939 PGN nedir?", text: "29-bit CAN ID içinden PGN, priority, source ve destination address çıkarın; PDU1 ile PDU2 farkını örneklerle görün.", href: "/learn/j1939-pgn-nedir/" },
  ...
  en: {
    ...
    featured: [
      ...
      { code: "PGN / 05", title: "What is a J1939 PGN?", text: "Extract the PGN, priority, source, and destination address from a 29-bit CAN ID and compare PDU1 with PDU2.", href: "/learn/j1939-pgn-nedir/" },
