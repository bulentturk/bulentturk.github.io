...
const content = {
  tr: {
    ...
    categories: [
      { code: "01", title: "CAN & J1939", text: "Fiziksel katmandan DBC, log analizi, ECU simülasyonu ve DM1 teşhisine uzanan uygulamalı öğrenme yolu.", state: "5 rehber yayında", href: "#can-j1939-rehberleri" },
    ...
    featured: [
      { code: "CAN TEST / 01", title: "CAN Bus arıza tespiti", text: "60 Ω terminasyon, CAN-H/CAN-L gerilimleri, bitrate, hata sayaçları ve bus-off durumunu doğru sırayla kontrol edin.", href: "/learn/can-bus-ariza-tespiti/" },
      { code: "DBC / 02", title: "DBC dosyası nedir?", text: "Mesaj, sinyal, factor, offset, byte order ve Standard/Extended CAN alanlarını uygulamalı öğrenin.", href: "/learn/dbc-dosyasi-nedir/" },
      { code: "CAN LOG / 03", title: "CAN log analizi nasıl yapılır?", text: "TRC, ASC, CSV ve candump kayıtlarında periyot, jitter, kayıp mesaj ve DBC sinyallerini inceleyin.", href: "/learn/can-log-analizi/" },
      { code: "ECU SIM / 04", title: "DBC ile ECU simülasyonu", text: "Fiziksel sinyal değerlerinden Standard veya Extended CAN payload üretin ve güvenli test akışını kurun.", href: "/learn/dbc-ile-ecu-simulasyonu/" },
      { code: "DM1 / 05", title: "J1939 DM1 mesajı nasıl çözülür?", text: "PGN 65226 içindeki lamba, SPN, FMI, OC ve CM alanlarını ham CAN verisinden çözümleyin.", href: "/learn/j1939-dm1-spn-fmi-cozumleme/" },
      { code: "FIELD / 06", title: "Hesap doğruysa makine neden farklı davranır?", text: "Komut, ham değer, ölçekli değer ve bağımsız ölçümü aynı zaman çizelgesinde karşılaştırma.", href: "/blog/#saha-dogrulamasi" },
    ],
  ...
  en: {
    ...
    categories: [
      { code: "01", title: "CAN & J1939", text: "A practical path from the physical layer through DBC, log analysis, ECU simulation, and DM1 diagnosis.", state: "5 guides published", href: "#can-j1939-rehberleri" },
    ...
    featured: [
      { code: "CAN TEST / 01", title: "CAN Bus fault diagnosis", text: "Check 60 Ω termination, CAN-H/CAN-L voltage, bitrate, error counters, and bus-off in the correct order.", href: "/learn/can-bus-ariza-tespiti/" },
      { code: "DBC / 02", title: "What is a DBC file?", text: "Learn messages, signals, factor, offset, byte order, and Standard/Extended CAN fields through examples.", href: "/learn/dbc-dosyasi-nedir/" },
      { code: "CAN LOG / 03", title: "How to analyze a CAN log", text: "Inspect period, jitter, missing messages, and DBC signals in TRC, ASC, CSV, and candump logs.", href: "/learn/can-log-analizi/" },
      { code: "ECU SIM / 04", title: "ECU simulation with a DBC", text: "Build Standard or Extended CAN payloads from physical signal values and follow a safe test workflow.", href: "/learn/dbc-ile-ecu-simulasyonu/" },
      { code: "DM1 / 05", title: "How to decode a J1939 DM1 message", text: "Decode lamp states, SPN, FMI, OC, and CM fields from a raw PGN 65226 message.", href: "/learn/j1939-dm1-spn-fmi-cozumleme/" },
      { code: "FIELD / 06", title: "Why does the machine behave differently when the math is right?", text: "Compare command, raw value, scaled value, and independent measurement on one timeline.", href: "/blog/#saha-dogrulamasi" },
    ],
