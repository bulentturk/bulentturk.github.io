  ...
  function boot(attempt) {
    ...
    if (prose && !document.getElementById("laGuideLinks")) {
      ...
      box.innerHTML =
        ...
        '<a href="/docs/a10vo-la-guide-download.html?lang=tr" style="color:var(--accent);text-decoration:underline">TR PDF</a>' +
        '<span style="color:var(--muted)"> · </span>' +
        '<a href="/docs/a10vo-la-guide-download.html?lang=en" style="color:var(--accent);text-decoration:underline">EN PDF</a>';
