  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "legal-gizlilik": resolve(__dirname, "gizlilik-politikasi/index.html"),
        "legal-cerez": resolve(__dirname, "cerez-politikasi/index.html"),
        "legal-kvkk": resolve(__dirname, "kvkk-aydinlatma-metni/index.html"),
      },
    },
  },
});
